angular.module('app.non-overrun').controller('NonOverrunItemEditCtrl',
  function ($scope, $state, sliderService, $modalInstance, $modal, requestService, item, itemIsNew,
    ...
    $scope.eloam = function(image){
      ...
      modalInstance = $modal.open({
        keyboard: true,
        size: "lg",
        templateUrl: apps + 'non-overrun/partials/eloam.html',
        controller: 'NonOverrunEloamCtrl'
        //,
        /*resolve: {
          item: function () {
    ...
    $scope.done = function () {
      ...
      requestService.overrunTodoItemDone($scope.item).success(function (res) {
        ...
        fullscreenModalInstance = $modal.open({
          keyboard: true,
          size: "fullscreen",
          templateUrl: apps + 'non-overrun/partials/docFullscreen.html',
          controller: 'NonOverrunViewerFullscreenCtrl',
          resolve: {
            item: function () {
      ...
      savePromise.success(function (res) {
        ...
        if (res.success) {
          ...
          modalInstance = $modal.open({
            ...
            controller: 'NonOverrunItemDiscussCtrl',
            resolve: {
              item: function () {
                return $scope.item;
              }
    ...
    $scope.zt = function () {
      ...
      requestService.overrunItemsZeTing($scope.item).success(function (res) {
        ...
        fullscreenModalInstance = $modal.open({
          keyboard: true,
          size: "fullscreen",
          templateUrl: apps + 'non-overrun/partials/docFullscreen-zt.html',
          controller: 'NonOverrunViewerFullscreenCtrl',
          resolve: {
            item: function () {
